...
# HEVC UDP stream 
gst-launch-1.0 udpsrc port=5000 ! queue ! application/x-rtp,media=video,encoding-name=H264,payload=96 ! rtpjitterbuffer ! rtph264depay ! queue ! h264parse ! v4l2h264dec ! autovideosink 
